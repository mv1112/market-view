    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white text-gray-900 border border-gray-300 max-w-5xl w-full max-h-[90vh] h-[90vh] rounded-lg overflow-hidden mx-4">
        ...
        <div className="flex items-center justify-between p-4">
          <h1 className="text-lg font-medium text-gray-900">Alerts</h1>
          <button 
            onClick={onClose}
                ...
                <div className="space-y-0.5">
                  {alertsList
                    ...
                    .map((alert, index) => (
                      ...
                      >
                        <span className="text-sm group-hover:text-gray-900 text-left">{alert}</span>
                        <div className="relative">
                          <span 
                            className="text-gray-600 group-hover:text-gray-700 text-xs font-mono"
                            title="Click to setup alert"
                          >
                            +
                          </span>
                        </div>
