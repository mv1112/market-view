...
export default function SettingsPopup({ isOpen, onClose }: SettingsPopupProps) {
  ...
  const renderSymbolSettings = () => (
    <div className="p-6 space-y-6">
      <div>
        <h3 className="text-sm font-medium text-gray-400 mb-4 uppercase tracking-wide">CANDLES</h3>
        
        {/* Color bars based on previous close */}
        <div className="flex items-center justify-between mb-6">
          <label className="text-sm text-gray-300">Color bars based on previous close</label>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-sm text-gray-300">Body</span>
          </div>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-sm text-gray-300">Borders</span>
          </div>
          <div className="flex space-x-2">
            <div className="w-8 h-6 bg-green-500 rounded cursor-pointer border border-gray-600"></div>
            <div className="w-8 h-6 bg-red-500 rounded cursor-pointer border border-gray-600"></div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className={`w-5 h-5 rounded border-2 transition-colors ${
                wickEnabled ? 'bg-blue-600 border-blue-600' : 'border-gray-500'
              }`}>
                {wickEnabled && (
                  <svg className="w-3 h-3 text-white m-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
            ...
            <span className="text-sm text-gray-300">Wick</span>
          </div>
          <div className="flex space-x-2">
            <div className="w-8 h-6 bg-green-500 rounded cursor-pointer border border-gray-600"></div>
            <div className="w-8 h-6 bg-red-500 rounded cursor-pointer border border-gray-600"></div>
      ...
      <div>
        <h3 className="text-sm font-medium text-gray-400 mb-4 uppercase tracking-wide">DATA MODIFICATION</h3>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <select 
            ...
            className="bg-gray-700 border border-gray-600 rounded px-3 py-1 text-sm text-white focus:outline-none focus:border-gray-500"
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <select 
            ...
            className="bg-gray-700 border border-gray-600 rounded px-3 py-1 text-sm text-white focus:outline-none focus:border-gray-500 max-w-xs"
          >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative bg-[#1a1a1a] text-white border border-gray-700 max-w-4xl w-full max-h-[90vh] h-[90vh] rounded-lg overflow-hidden mx-4 flex">
        
        {/* Left Sidebar */}
        <div className="w-64 bg-[#131313] border-r border-gray-700 flex flex-col">
          {/* Header */}
          ...
          <nav className="flex-1 py-2">
            {navigationItems.map((item) => (
              ...
              >
                <span className={selectedCategory === item.id ? 'text-blue-500' : 'text-gray-400'}>
                  {item.icon}
                </span>
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Bottom Actions */}
          <div className="border-t border-gray-700 p-4 flex items-center justify-between bg-[#1a1a1a]">
            {/* Template Dropdown */}
            <div className="relative">
              <button
                onClick={() => setIsTemplateDropdownOpen(!isTemplateDropdownOpen)}
                className="bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded px-4 py-2 text-sm text-white flex items-center space-x-2 transition-colors"
              >
              ...
              {isTemplateDropdownOpen && (
                <div className="absolute bottom-full left-0 mb-1 bg-gray-700 border border-gray-600 rounded shadow-lg min-w-full z-10">
