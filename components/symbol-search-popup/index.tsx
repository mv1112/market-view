...
export default function SymbolSearchPopup({ isOpen, onClose, onSymbolSelect }: SymbolSearchPopupProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="bg-gray-900 text-white border-gray-700 max-w-2xl w-full max-h-[80vh] p-0 gap-0">
        {/* Header */}
        ...
        <div className="p-4 border-b border-gray-700">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-800 border border-gray-600 rounded text-white placeholder-gray-400 focus:outline-none focus:border-white"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto max-h-96">
          {filteredInstruments.map((instrument) => (
            <div
              ...
              className="flex items-center justify-between p-3 hover:bg-gray-800 cursor-pointer border-b border-gray-800 last:border-b-0"
            >
              ...
              <div className="flex items-center gap-2">
                {instrument.category && (
                  <span className="text-xs text-gray-400">{instrument.category}</span>
                )}
