      ...
      <div className="flex items-center justify-between p-2 border-b border-gray-700">
        <div className="flex items-center space-x-2">
          <div className="relative">
            <button className="flex items-center px-3 py-1 text-sm bg-gray-800 rounded hover:bg-gray-700">
      ...
      <div className="flex items-center p-2 border-b border-gray-700 overflow-x-auto">
        <div className="flex space-x-2">
          {filterOptions.map((option) => (
            <button
              key={option.id}
              className="px-3 py-1 text-xs bg-gray-800 rounded hover:bg-gray-700 whitespace-nowrap"
            >
              {option.label}
            </button>
          ))}
