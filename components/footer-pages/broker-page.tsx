        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full md:w-72 bg-gray-900 border border-gray-800 rounded-lg px-4 py-2.5 text-base text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-white/20 transition-all"
            />
            <svg
            ...
            <button
              ...
              className={cn(
                ...
                selectedCategory === (category === 'All' ? null : category) 
                  ...
                  : "border-gray-800 text-gray-300 hover:bg-gray-800/50 hover:border-gray-700"
              )}
            >
              {category}
            </button>
