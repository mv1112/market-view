...
const InlineComments: FC = () => {
	return (
		<div className={styles.inline__comments}>
			...
			<span className={styles.heading}>Annotate trades </span>

			<span className={styles.paragraph}>
				Discuss trade ideas directly on charts and refine your strategy analysis{' '}
	...
	return (
		<div className={styles.comment__popup}>
			<div className={styles.comment__container}>
				...
				<span className={styles.user__comment}>great entry point here!</span>
			</div>
