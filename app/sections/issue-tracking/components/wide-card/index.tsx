		...
		<div className={styles.wide__card}>
			<div className={styles.heading__wrapper}>
				<div className={styles.head__container}>
					<BentoCardHeading
						title='ViewMarket Analytics'
						description='Take the guesswork out of trading with real-time market analysis, AI-powered insights, and advanced charting tools.'
					/>
